...
namespace IdentityNpgsqlNodatime.Web
{
    public class SeedData
    {
        public static void EnsureSeedData(IServiceProvider serviceProvider)
        {
            ...
            {
                scope.ServiceProvider.GetRequiredService<ApplicationPersistedGrantDbContext>().Database.Migrate();
        ...
        private static void EnsureSeedData(ApplicationConfigurationDbContext context)
        {
